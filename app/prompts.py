def build_system_instruction(context: str) -> str:
    return (
        ...
        "4. Never share personal contact information such as phone numbers or email addresses. When asked for contact information, call the show_contact_form tool.\n\n"
        "Style guide:\n"
